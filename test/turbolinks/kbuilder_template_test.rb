...
class KbuilderTemplateTest < ActionView::TestCase
  ...
  test "rendering" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      Turbolinks.replace({"data":{"content":"hello"}});
    JS
  ...
  test "render with asset tracking" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      Turbolinks.replace({"data":{"content":"hello"},"turbolinks":{"assets":["/test.js","/test.css"]}});
    JS
  ...
  test "render with csrf token when request forgery is on" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      Turbolinks.replace({"data":{"content":"hello"},"turbolinks":{"csrf_token":"secret"}});
    JS
  ...
  test "wrapping jbuilder contents inside Turbolinks with additional options" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      Turbolinks.replace({"data":{"content":"hello"},"turbolinks":{"title":"this is fun","assets":["/test.js","/test.css"]}});
    JS
  ...
  test "key_format! with parameter" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      Turbolinks.replace({"data":{"camelStyle":"for JS"}});
    JS
  ...
  test "renders a partial with no locals" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      Turbolinks.replace({"data":{"footer":{"terms":"You agree"}}});
    JS
    assert_equal expected, result
  end
  ...
  test "renders a partial with locals" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      Turbolinks.replace({"data":{"profile":{"email":"test@test.com"}}});
    JS
    assert_equal expected, result
  end
  ...
  test "renders a partial with locals and caches" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":{"profile":Turbolinks.cache["fbf68bd43dba9d0054ad02b65b7bb4aa"]}});
    JS
  ...
  test "render array of partials without an :as to a member, this usage is very rare" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      Turbolinks.replace({"data":[{"terms":"You agree"},{"terms":"You agree"}]});
    JS
  ...
  test "render array of partials without an :as to a member and cache" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":[Turbolinks.cache["0d6be77bebdef3fee771f21b49d51806"],Turbolinks.cache["c88c9332e539d4f3740f3c44575a1ebc"]]});
    JS
  ...
  test "caching a value at a node" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":{"hello":Turbolinks.cache["420dd59aa351baf103b4184869dfe516"]}});
    JS
  ...
  test "caching elements in a list" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":{"hello":[Turbolinks.cache["31a0b2d69da777bb2dcf027350566f1d"],Turbolinks.cache["e9b9b9b98dafc029c4e814b091e90a7a"]]}});
    JS
  ...
  test "list elements (cached and non cached) merges in the same scope" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":{"hello":[Turbolinks.cache["31a0b2d69da777bb2dcf027350566f1d"],Turbolinks.cache["e9b9b9b98dafc029c4e814b091e90a7a"],3,4,Turbolinks.cache["4237e6f58bfe464b27ee270b55c12e84"],Turbolinks.cache["34cfb415aba6256e9aaf661a8697248c"]]}});
    JS
  ...
  test "nested caching generates a depth-first list of cache nodes" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":{"hello":Turbolinks.cache["64af83f0566cd020f44ca0b25121fc58"]}});
    JS
  ...
  test "child! accepts cache options" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":{"comments":[Turbolinks.cache["423c34f3270addc1369ee6d95d662c04"],{"content":"world"}]}});
    JS
  ...
  test "fragment caching" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":{"post":Turbolinks.cache["c6eb1da804069b92da0553e647a6770a"]}});
    JS
  ...
  test "fragment caching deserializes an array" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":{"content":Turbolinks.cache["c6eb1da804069b92da0553e647a6770a"]}});
    JS
  ...
  test "does not perform caching when controller.perform_caching is false" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      Turbolinks.replace({"data":{"content":{"name":"Cache"}}});
    JS
  ...
  test "invokes templates via params via set! and caches" do
    ...
    expected = strip_format(<<-JS.strip_heredoc)
      ...
      Turbolinks.replace({"data":{"post":Turbolinks.cache["fedd00e5759ffda2b4ac1aeb6f2a7dde"]}});
    JS
